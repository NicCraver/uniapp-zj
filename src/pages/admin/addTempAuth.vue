...
<template>
  ...
  >
    ...
    <div bg="#EFEFEF" h="100vh">
      ...
      <nut-popup v-if="showStart" v-model:visible="showStart" position="bottom">
        <nut-date-picker
          v-model="currentDate"
          title="起始时间"
          type="datehour"
      ...
      <nut-popup v-if="showEnd" v-model:visible="showEnd" position="bottom">
        <nut-date-picker
